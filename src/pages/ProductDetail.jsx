				...
				<div className="product-detail-content">
					...
					>
						...
						<div className="product-actions">
							<a
								href={`https://wa.me/905427807923?text=${encodeURIComponent(
									`https://dmstekstil.com/urunler/${product.id} Linkteki ürün ile ilgili daha fazla bilgi almak istiyorum`
								)}`}
								target="_blank"
